 ...
 */
var middlePoint = (startPoint, endPoint) => {
 ...
 */
var getDistance = (startPoint,endPoint) => {
 ...
 */
var randomPointsInPolygon = (polygon, bbox, nb_points) => {
  var i = 0;
  var points = [];
  while (i < nb_points) {
 ...
 */
var randomPointInPolygon = (polygon, bbox) => {
  var point = randomPointInBbox(bbox);
...
var insidePolygon = (point, polygon) => {
...
var splitTrip = (tripPoints, minimumDistance) => {
...
var splitTripLoop = (tripPoints, minimumDistance) => {
