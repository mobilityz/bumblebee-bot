 ...
 */
var generate_trip = function(params, callback) {
    var latLngs = params.bot.zone.properties.latLngs;
    var bbox = params.bot.zone.properties.bbox;
    if (!params.origin) {
      var start_points = geometry.randomPointInPolygon(latLngs, bbox);
    }
    else {
      var start_points = params.origin
    }
